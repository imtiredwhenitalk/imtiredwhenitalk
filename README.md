...
- Work with databases and connect frontend + backend + data layer
- Use TypeScript to make code safer, more predictable, and easier to maintain
- Containerize projects with Docker for reproducible development and deployment 
- Apply basic API security and organize project architecture
- Improve existing projects through refactoring, bug fixing, and optimization
## Practical Knowledge
